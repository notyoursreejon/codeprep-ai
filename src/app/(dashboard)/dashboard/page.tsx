...
<a class="px-space-md py-space-sm rounded-lg bg-surface-container-high group-hover:bg-primary group-hover:text-on-primary text-on-surface font-body-sm text-body-sm font-medium transition-all flex items-center gap-1 shadow-sm" href="#">
<span>Continue</span>
...
<div class="shrink-0 flex items-center gap-space-sm">
<a class="px-space-md py-space-sm rounded-lg bg-surface-container-high group-hover:bg-secondary-container group-hover:text-on-secondary-container text-on-surface font-body-sm text-body-sm font-medium transition-all flex items-center gap-1 shadow-sm" href="#">
