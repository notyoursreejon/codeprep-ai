...
export const StatsCard = React.forwardRef<HTMLDivElement, StatsCardProps>(
  ({ 
    title, currentValue, valuePrefix, valuePostfix, description, chartData, onActionClick, className,
    defaultBarColor = "bg-primary/20", highlightedBarColor = "bg-destructive" 
  }, ref) => {
    ...
    return (
      <MotionCard
        ref={ref}
        className={cn("w-full max-w-sm overflow-hidden dark:bg-zinc-950 dark:border-white/10", className)}
      ...
      >
        ...
        <CardContent>
          <div ref={cardRef} className="flex flex-col gap-4">
            ...
            <motion.div className="flex h-20 w-full items-end gap-3" initial="hidden" animate={controls} transition={{ staggerChildren: 0.1 }} aria-label="Monthly revenue chart">
