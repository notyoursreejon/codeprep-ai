  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#09090b] relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-[#0c0c0e] border border-white/10 rounded-2xl p-8 shadow-2xl">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input 
                ...
                className="w-full bg-[#09090b] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
              />
            </div>
          ...
          <div className="mt-8 flex items-center justify-between before:flex-1 before:border-t before:border-white/10 after:flex-1 after:border-t after:border-white/10">
             <span className="px-4 text-xs text-neutral-500 uppercase tracking-widest font-medium">Or continue with</span>
          </div>

          <div className="mt-6 flex gap-4">
            <Button variant="outline" className="w-full h-11 bg-white/5 border-white/10 hover:bg-white/10">
