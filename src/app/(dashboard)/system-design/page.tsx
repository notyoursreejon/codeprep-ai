    ...
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <div className="mb-6 flex justify-between items-end">
        ...
        <div className="flex gap-2">
           <select 
             className="bg-input border border-border text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-primary"
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-6 min-h-0">
        ...
        <div className="flex flex-col border border-border rounded-xl overflow-hidden bg-background">
          ...
          <div className="p-4 border-t border-border bg-white/5 flex justify-end">
        ...
        {/* Feedback Area */}
        <div className="flex flex-col border border-border rounded-xl bg-card overflow-y-auto">
          <div className="p-6">
            {!rubric && !isEvaluating && (
              ...
              <div className="space-y-6 animate-in fade-in">
                ...
                <div className="space-y-3">
                  {rubric.map((item: any, i: number) => (
                    <div key={i} className="bg-white/5 border border-border rounded-lg p-4 flex flex-col gap-2">
