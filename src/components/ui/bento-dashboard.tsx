...
// =========================================
// 4. MAIN BENTO LAYOUT (THE COMPONENT)
// =========================================
export default function BentoDashboard() {
  return (
    <div className="w-full bg-zinc-100 dark:bg-black p-4 md:p-8 font-sans selection:bg-black selection:text-white dark:selection:bg-white dark:selection:text-black flex flex-col transition-colors duration-200 rounded-2xl border border-black/10 dark:border-white/10">
      <div className="max-w-7xl w-full mx-auto relative z-10 flex flex-col flex-1">
        <header className="mb-6 md:mb-8">
          <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-2 text-black dark:text-white">
            System Analytics & Infrastructure
          </h1>
          <p className="font-bold text-zinc-500 dark:text-zinc-400 uppercase tracking-widest text-xs md:text-sm">
            Live Telemetry & Evaluation Load Overview
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 auto-rows-[minmax(0,1fr)]">
          ...
          <div className="h-full min-h-[480px] lg:h-auto flex">
